    ...
    <div class="list-group-item">
        <div class="d-flex">
            ...
            if ($this->Dados['botao']['list_carousel']) {
                ?>
                <div class="p-2">
                <a href="<?php echo URLADM . 'carousel/listar'; ?>" class="btn btn-outline-info btn-sm">Listar</a>
            </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    ?>
                    <img src="<?php echo $imagem_antiga; ?>" alt="Imagem do slide" id="preview-user" class="img-thumbnail" style="width: 250px; height: 120px;">
                </div>
            </div>
            ...
            <input name="CadCarousel" type="submit" class="btn btn-warning" value="Salvar">
        </form>
    </div>
</div>
