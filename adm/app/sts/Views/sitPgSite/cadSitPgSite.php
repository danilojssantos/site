    ...
    <div class="list-group-item">
        <div class="d-flex">
            ...
            if ($this->Dados['botao']['list_sit_pg']) {
                ?>
                <div class="p-2">
                <a href="<?php echo URLADM . 'sit-pg-site/listar'; ?>" class="btn btn-outline-info btn-sm">Listar</a>
            </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input name="nome" type="text" class="form-control" placeholder="Nome da situação de pagina do site" value="<?php
