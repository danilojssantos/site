    ...
    <div class="list-group-item">
        <div class="d-flex">
            ...
            if ($this->Dados['botao']['vis_cat_art']) {
                ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'ver-cat-artigo/ver-cat-artigo/' . $valorForm['id']; ?>" class="btn btn-outline-primary btn-sm">Visualizar</a>
                </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <input name="EditCatArtigo" type="submit" class="btn btn-warning" value="Salvar">
        </form>
    </div>
</div>
